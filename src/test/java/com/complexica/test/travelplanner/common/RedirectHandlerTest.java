...
import static com.complexica.test.travelplanner.common.RedirectHandler.FLASH_MODEL_ATTRIBUTE_NAME;
...
class RedirectHandlerTest {
  ...
  void addModelToRedirectAttributes_shouldAddModelToRedirectAttributesInFlashAttribute() {
    ...
    //then:
    verify(redirectAttributesMock).addFlashAttribute(FLASH_MODEL_ATTRIBUTE_NAME, modelMock);
